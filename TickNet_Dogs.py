...
def get_data_loader(args, train):
    ...
    # -------------------------------------------------------------------------
    # CẢI TIẾN: Không kích hoạt tính năng download
    # Ép đường dẫn root='./data' (thư mục data nằm chung chỗ với file chạy)
    # Gán download=False để đọc trực tiếp dữ liệu offline
    # -------------------------------------------------------------------------
